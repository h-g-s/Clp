...
*/
void
establishParams (std::vector<CbcOrClpParam> &parameters )
{
    parameters.clear();
...
best less than this", 0.0, 1.0e20, CBC_PARAM_DBL_ALLOWABLEGAP);
...
gap between bounds exceeds this value", 1.0e-20, 1.0e12, CLP_PARAM_DBL_DUALBOUND);
        p.setLonghelp(
...
reduced costs greater than this", -1.0e20, 1.0e20, CBC_PARAM_DBL_DJFIX, 1);
        p.setLonghelp(
...
much better than last integer solution", -1.0e20, 1.0e20, CBC_PARAM_DBL_INCREMENT);
...
to cost this much", 0.0, 1.0e20, CBC_PARAM_DBL_INFEASIBILITYWEIGHT, 1);
        p.setLonghelp(
...
stopping", 0, 2147483647, CLP_PARAM_INT_MAXITERATION);
     p.setLonghelp(
