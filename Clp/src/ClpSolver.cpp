                    ...
                    if (type == CBC_PARAM_GENERALQUERY) {
                         ...
                         int printLevel =
                              parameters[whichParam(CLP_PARAM_STR_ALLCOMMANDS,
                                                    parameters)].currentOptionAsInteger();
                         int convertP[] = {2, 1, 0};
			   ...
			   break; // stop all
				...
				if (type==CLP_PARAM_ACTION_EITHERSIMPLEX||
				  ...
				  models[iModel].setMoreSpecialOptions(16384|
                                   ...
                                   double objScale =
                                        parameters[whichParam(CLP_PARAM_DBL_OBJSCALE2, parameters)].doubleValue();
                                   if (objScale != 1.0) {
                                        int iColumn;
				   ...
				   if (smallCode!=-1)
					...
					parameters[whichParam(CLP_PARAM_INT_DUALIZE, 
							      parameters)].setIntValue(dualize);
                                   }
                                   if (status >= 0)
                                        basisHasValues = 1;
                              } else {
                              ...
                              if (goodModels[iModel]) {
                                   ...
                                   if (preSolve) {
                                        ...
                                        double presolveTolerance =
                                             parameters[whichParam(CLP_PARAM_DBL_PRESOLVETOLERANCE, parameters)].doubleValue();
                                        model2 =
