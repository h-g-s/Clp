...
/* $Id: CbcOrClpParam.hpp 2259 2017-03-27 08:37:20Z forrest $ */
...

{
     ...
     CBC_PARAM_STR_MERGECLIQUES,
     /*----------SAMUEL_BRITO----------*/
     CBC_PARAM_STR_AGGRCLIQUECUTS,
     CBC_PARAM_STR_USRODDHOLECUTS,
     CBC_PARAM_STR_EXTKNAPSACKCUTS,
     /*-------------------------------*/
