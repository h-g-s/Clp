...
int main(int argc, const char *argv[])
{
  ...
  if (numberGub > 0) {
    ...
    // test proper restart
    if (argc > 3) {
      ClpDynamicMatrix *oldMatrix = dynamic_cast< ClpDynamicMatrix * >(model2.clpMatrix());
      assert(oldMatrix);
      ClpDynamicMatrix *newMatrix = new ClpDynamicMatrix(&model3, numberGub,
        numberColumns, gubStart,
        lower, upper,
        start2, row2, element2, cost2,
        lowerColumn2, upperColumn2,
      ...
      ClpDynamicExampleMatrix *oldMatrix = dynamic_cast< ClpDynamicExampleMatrix * >(model2.clpMatrix());
      assert(oldMatrix);
      ClpDynamicExampleMatrix *newMatrix = new ClpDynamicExampleMatrix(&model3, numberGub,
        numberColumns, gubStart,
        lower, upper,
        start2, row2, element2, cost2,
        lowerColumn2, upperColumn2,
    ...
    assert(gubMatrix);
    ClpDynamicExampleMatrix *gubMatrix2 = dynamic_cast< ClpDynamicExampleMatrix * >(model2.clpMatrix());
    if (!gubMatrix2) {
      ...
      for (; i < originalNumberRows; i++)
        assert(rowsol2[i] > lower[i - numberStaticRows] - 1.0e-3 && rowsol2[i] < upper[i - numberStaticRows] + 1.0e-3);
      //for (;i<originalNumberRows;i++)
      //printf("%d %g\n",i,rowsol2[i]);
